...
const Hero = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20 pb-10 md:pt-24">
      {/* Background Image */}
      <div
        className="absolute inset-0 bg-cover bg-center bg-no-repeat"
        style={{
          backgroundImage: 'url(/images/quest-real-7.jpg)',
      ...
      {/* Radiation Warning — на мобильных скрыт, чтобы не наезжал на заголовок */}
      <div className="hidden md:flex absolute top-28 right-8 items-center space-x-2 text-yellow-500 animate-pulse">
      ...
      <div className="relative z-10 text-center px-4 max-w-5xl mx-auto">
        ...
        {/* Stats */}
        <div className="grid grid-cols-2 sm:flex sm:flex-wrap justify-center gap-3 md:gap-8 mb-10">
          <div className="stalker-card px-3 py-3 md:px-6 md:py-4 flex items-center justify-center space-x-2 md:space-x-3">
