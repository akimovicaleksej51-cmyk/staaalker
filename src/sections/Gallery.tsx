...
const Gallery = () => {
  ...
  // objectPosition подобран индивидуально под портретные кадры, чтобы человек не обрезался.
  const images = [
    { src: '/images/quest-real-1.jpg', alt: 'Актёр рассматривает записи о мутантах на стене', pos: 'center' },
    { src: '/images/quest-real-2.jpg', alt: 'Конфликт у барной стойки в Зоне', pos: 'center 15%' },
    { src: '/images/quest-real-3.jpg', alt: 'Сталкер выглядывает из-под тента', pos: 'center' },
    { src: '/images/quest-real-4.jpg', alt: 'Боец в противогазе патрулирует базу', pos: 'center 35%' },
    { src: '/images/quest-real-5.jpg', alt: 'Оружие направлено на пленного в противогазе', pos: 'center 30%' },
    { src: '/images/quest-real-6.jpg', alt: 'Сталкер с автоматом в дыму', pos: 'center' },
    { src: '/images/quest-real-7.jpg', alt: 'Фигура в капюшоне со светящимся артефактом', pos: 'center' },
    { src: '/images/quest-real-8.jpg', alt: 'Бармен за стойкой «100 рентген»', pos: 'center' },
  ];
  ...
  return (
    <section id="gallery" ref={sectionRef} className="py-20 md:py-32 bg-black relative">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Главное фото — карусель с кроссфейдом; окно уже, т.к. фото портретные */}
        <div
          className={`relative overflow-hidden rounded border border-orange-500/30 max-w-2xl mx-auto h-[380px] sm:h-[460px] md:h-[560px] mb-4 transition-all duration-700 delay-150 ${
            isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
          }`}
        >
