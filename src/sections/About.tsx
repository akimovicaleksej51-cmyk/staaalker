  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-3xl md:text-5xl font-bold text-gradient font-['Orbitron'] mb-4">
            О КВЕСТЕ
          </h2>
          <div className="w-24 h-1 bg-gradient-to-r from-orange-600 to-orange-400 mx-auto"></div>
        </div>
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="stalker-card p-4 text-center">
                <div className="text-3xl font-bold text-orange-500">408</div>
                <div className="text-gray-400 text-sm">Оценок</div>
              </div>
              <div className="stalker-card p-4 text-center">
                <div className="text-3xl font-bold text-orange-500">422</div>
