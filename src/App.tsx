...
import SoundZone from './sections/SoundZone';
    ...
    return (
      <div className="fixed inset-0 bg-black flex items-center justify-center z-50 px-4">
        <div className="text-center w-full">
          <div
            className="font-bold text-orange-500 mb-4 font-['Orbitron'] animate-pulse whitespace-nowrap"
            style={{ fontSize: 'clamp(1.5rem, 9vw, 3.75rem)' }}
          >
            S.T.A.L.K.E.R.
          </div>
          <div className="text-lg sm:text-xl md:text-2xl text-orange-400 font-['Orbitron']">
            Сердце Зоны
          </div>
          <div className="mt-8 w-56 sm:w-64 h-2 bg-zinc-800 rounded-full overflow-hidden mx-auto">
